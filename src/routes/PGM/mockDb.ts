...
export let storage: Record<string, Product> = {
    ...
    "bibPlusJerseys": {
        ...
        imageSrc: "Resources/1BibPlus2Jerseys.png",
    ...
    "radaSocks": {
        id: 3,
        name: { en: "PGM Socks", es: "Calcetines PGM" },
        categoryIds: [6, 7, 8, 9, 10, 11, 12, 13, 15, 16, 17, 18, 19, 20, 21],
        description: {
            en: "Step into comfort with PGM Socks — where coziness meets style. These premium socks hug your feet with softness while offering a snug fit, perfect for any adventure. At just $16.00, they're a steal from their usual $25.00. Upgrade your sock drawer and walk in a cloud of comfort!",
            es: "Adéntrate en el confort con los Calcetines PGM — donde la comodidad se encuentra con el estilo. Estos calcetines premium abrazan tus pies con suavidad mientras ofrecen un ajuste perfecto, ideal para cualquier aventura. Por solo $16.00, son una ganga de su precio habitual de $25.00. ¡Mejora tu cajón de calcetines y camina en una nube de confort!"
        },
        details: [
        ...
        imgHoverSrc: undefined,
        imageAlt: { en: "PGM Socks", es: "Calcetines PGM" },
        price: "$16.00",
        oldPrice: "$25.00",
        versions: undefined,
        href: "rada-socks",
...
export let reviews: Review[] = [
    // Jersey
    {
        productId: 0,
        date: '01-20-2024',
        text: 'Bonito color y buena calidad de tela. Esta es la talla perfecta y la versión azul combina perfectamente con mi estilo.',
        name: 'alejandro_rodr',
    ...
    },
    {
        productId: 0,
        date: '01-25-2024',
        text: 'Me encanta la nueva Camiseta 2024, el color rojo es vibrante y es muy cómoda de llevar.',
        name: 'sarahc',
    ...
    },
    {
        productId: 0,
        date: '02-01-2024',
        text: 'La Camiseta 2024 es increíble. Queda a la medida y es perfecta para cualquier evento.',
        name: 'markuslee',
    ...
    },
    {
        productId: 0,
        date: '02-05-2024',
        text: 'Gran camiseta, el material es de alta calidad y el rojo es justo el tono correcto. ¡Lo recomiendo mucho!',
        name: 'annak',
    ...
    },
    {
        productId: 0,
        date: '02-10-2024',
        text: 'Compré la Camiseta 2024 para mis sesiones de entrenamiento, y ha sido fantástica. ¡Transpirable y flexible!',
        name: 'lucas98',
    ...
    // Cycling Bib
    {
        productId: 1,
        date: '03-01-2024',
        text: 'El Pantalón de Ciclismo 2024 es un cambio de juego. El ajuste es excepcional y proporciona la comodidad necesaria en recorridos largos. ¡Calidad de primera!',
        name: 'michaelsmith',
        imageSrc: '/images/lawyers/Brian_Mitchell.jpg',
        rating: 5,
    },
    {
        productId: 1,
        date: '03-04-2024',
        text: 'Acabo de terminar un recorrido de un siglo con el Pantalón de Ciclismo 2024, y no podría estar más feliz. Soportivo, elegante y el color azul es impresionante!',
        name: 'julie_w',
        imageSrc: '/images/lawyers/Sofia_Lindström.jpg',
        rating: 5,
    },
    {
        productId: 1,
        date: '03-07-2024',
        text: 'El Pantalón de Ciclismo 2024 rojo se ajusta como un guante y respira muy bien. Es mi nuevo favorito para todas mis giras de ciclismo.',
        name: 'daveanderson',
    ...
    },
    {
        productId: 1,
        date: '03-10-2024',
        text: '¡Increíble comodidad y diseño elegante! El Pantalón de Ciclismo 2024 ha hecho mis paseos más disfrutables. Lo recomiendo mucho a cualquier ciclista.',
        name: 'lindseyb',
    ...
    // Bib + Jersey + Socks Offer
    {
        productId: 2,
        date: '01-30-2024',
        text: 'El nivel de comodidad del combo de Pantalón + Camiseta es incomparable, ¡y los calcetines gratis son un bono increíble! Vale cada centavo.',
        name: 'emilywright',
        imageSrc: '/images/lawyers/Emily_Davis.jpg',
        rating: 5,
    },
    {
        productId: 2,
        date: '02-15-2024',
        text: '¡Una oferta insuperable! La camiseta queda como una segunda piel y los pantalónes son justo la cantidad adecuada de ajuste. Además, calcetines gratis - ¡increíble!',
        name: 'jordanm',
        imageSrc: '/images/lawyers/Brian_Mitchell.jpg',
        rating: 5,
    },
    {
        productId: 2,
        date: '02-20-2024',
        text: 'Un conjunto fantástico para cualquier ciclista! Los materiales son de primera y lucen profesionales. Los calcetines son la guinda del pastel.',
        name: 'sophiag',
        imageSrc: '/images/lawyers/Ji-Yeon_Kim.jpg',
        rating: 4,
    },
    {
        productId: 2,
        date: '02-28-2024',
        text: 'Acabo de hacer un recorrido de un siglo en mi nuevo Pantalón + Camiseta, y se desempeñaron excelentemente. Los calcetines mantuvieron mis pies cómodos durante todo el trayecto.',
        name: 'liammurphy',
        imageSrc: '/images/lawyers/Marcus_Turner.jpg',
        rating: 5,
    },
    ...
    // Rada Socks
    {
        productId: 3,
        date: '03-01-2024',
        text: '¡Estos calcetines PGM son un cambio de juego! Súper cómodos para mis carreras diarias y con estilo suficiente para usar a diario.',
        name: 'julianv',
        imageSrc: '/images/lawyers/Marcus_Turner.jpg',
        rating: 5,
    },
    {
        productId: 3,
        date: '03-03-2024',
        text: 'Estaba escéptica sobre el precio, pero estos calcetines valen cada centavo. ¡Se siente como caminar sobre nubes!',
        name: 'emilyrose',
        imageSrc: '/images/lawyers/Ji-Yeon_Kim.jpg',
        rating: 4,
    },
    {
        productId: 3,
        date: '03-05-2024',
        text: 'Compré estos para mis excursiones de senderismo y han sido fantásticos. ¡Sin ampollas y mis pies se mantienen secos!',
        name: 'mikejones',
        imageSrc: '/images/lawyers/Brian_Mitchell.jpg',
        rating: 4,
    },
    {
        productId: 3,
        date: '03-07-2024',
        text: 'El nivel de comodidad de los Calcetines PGM es inmejorable. Además, ¡lucen geniales con todos mis zapatos!',
        name: 'anna_k',
        imageSrc: '/images/lawyers/Emily_Davis.jpg',
        rating: 4,
    },
