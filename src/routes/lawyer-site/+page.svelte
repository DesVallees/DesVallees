...
<div class="home" in:fade>
	<section class="initial">
		<div class="left">
			...
			<a class="button explore" href="/lawyer-site/services"
				>{$dictionary.exploreOurServices}</a
			>
		</div>
		<div class="right">
			<img
				src="/images/lawyers/landingImage.webp"
				width="500px"
				alt={$dictionary.lawyersImageDescription}
			/>
		</div>
	</section>
	...
	<section class="overview">
		...
		<a class="button" style="min-width: 200px;" href="/lawyer-site/contact"
			>{$dictionary.contactUs}</a
		>
	</section>
