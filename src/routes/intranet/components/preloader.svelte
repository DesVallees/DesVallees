...
<div class="overlay" out:fade|global {style}>
	<slot />

	{#if animation === 'default'}
		<div class="default" style="transform: scale({scale})">
			<div />
			<div />
			<div />
			<div />
	...
	{:else if animation === 'circle'}
		<div class="circle" style="transform: scale({scale})"><div /></div>
	{:else if animation === 'dots'}
		<div class="dots" style="transform: scale({scale})">
			<div />
			<div />
			<div />
			<div />
