<script lang="ts">
	...
	let profileNotification = notifications.find(
		(profileNotification) => profileNotification.id === notificationID,
	);
...
{#if profileNotification}
	<div class="notification" out:slide|global>
		<header>
			...
			{/if}
			<button aria-label={$dictionary.dismissNotification} on:click={dismiss}
