	...
	<header class="landing-header">
		<div class="header-container">
			...
			<nav class="header-nav">
				...
				<button class="login-btn" on:click={() => goto('/vaqmas/login')}>
					Iniciar Sesión
				</button>
			</nav>
		</div>
		...
		<div class="hero-container">
			<div class="hero-content">
				...
				<div class="hero-actions">
					<button class="cta-btn primary" on:click={() => goto('/vaqmas/login')}>
						Acceder al Sistema
					</button>
					<button
			...
			<div class="hero-visual">
				<div class="hero-image-container">
					<img src="/images/vaqmas/logo.png" alt="VAQ+ App" class="hero-app-image" />
				</div>
			</div>
		</div>
	</section>
			...
			<div class="about-content">
				...
				<div class="about-visual">
					<div class="about-image-container">
						<img src="/images/vaqmas/logo.png" alt="VAQ+ Team" class="about-image" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="footer-content">
				<div class="footer-logo">
					<img src="/images/vaqmas/logo.png" alt="VAQ+ Logo" class="footer-logo-image" />
					<p>Vacunación y Cuidado Pediátrico</p>
				</div>
