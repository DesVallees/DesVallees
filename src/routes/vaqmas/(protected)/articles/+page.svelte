...
<div class="articles-page">
	...
	<div class="actions-bar">
		...
		<button
			class="create-btn"
			on:click={() => (window.location.href = '/vaqmas/articles/create')}
		>
							...
							<td>
								<div class="action-buttons">
									...
									<button
										...
										on:click={() =>
											(window.location.href = `/vaqmas/articles/${article.id}/edit`)}
										title="Editar"
									>
										<svg viewBox="0 0 24 24">
											<path
				...
				<div class="modal-footer">
					...
					<button
						...
						on:click={() => {
							if (selectedArticle) {
								closeDetails();
								window.location.href = `/vaqmas/articles/${selectedArticle.id}/edit`;
							}
						}}
					>
						Editar Artículo
