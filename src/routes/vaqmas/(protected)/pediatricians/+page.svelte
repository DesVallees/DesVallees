...
<div class="pediatricians-page">
	<div class="page-header">
		<div class="header-content">
			<div class="header-logo">
				<img src="/images/vaqmas/logo.png" alt="VAQ+ Logo" class="header-logo-image" />
	...
	<div class="actions-bar">
		...
		<button
			class="create-btn"
			on:click={() => (window.location.href = '/vaqmas/pediatricians/create')}
		>
							...
							<td>
								<div class="action-buttons">
									...
									<button
										...
										on:click={() =>
											(window.location.href = `/vaqmas/pediatricians/${pediatrician.id}/edit`)}
										title="Editar"
									>
										<svg viewBox="0 0 24 24">
											<path
					...
					<button
						...
						on:click={() => {
							if (selectedPediatrician) {
								closeDetails();
								window.location.href = `/vaqmas/pediatricians/${selectedPediatrician.id}/edit`;
							}
						}}
					>
						Editar Pediatra
