...
<div class="users-page">
	...
	<div class="actions-bar">
		...
		<button class="create-btn" on:click={() => (window.location.href = '/vaqmas/users/create')}>
							...
							<td>
								<div class="action-buttons">
									...
									<button
										...
										on:click={() =>
											(window.location.href = `/vaqmas/users/${user.id}/edit`)}
										title="Editar"
									>
										<svg viewBox="0 0 24 24">
											<path
				...
				<div class="modal-footer">
					...
					<button
						...
						on:click={() => {
							if (selectedUser) {
								closeDetails();
								window.location.href = `/vaqmas/users/${selectedUser.id}/edit`;
							}
						}}
					>
						Editar Usuario
