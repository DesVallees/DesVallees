...
<div class="appointments-page">
	...
	<div class="actions-bar">
		...
		<button
			class="create-btn"
			on:click={() => (window.location.href = '/vaqmas/appointments/create')}
		>
							...
							<td>
								<div class="action-buttons">
									...
									<button
										...
										on:click={() =>
											(window.location.href = `/vaqmas/appointments/${appointment.id}/edit`)}
										title="Editar"
									>
										<svg viewBox="0 0 24 24">
											<path
					...
					<button
						...
						on:click={() => {
							if (selectedAppointment) {
								closeDetails();
								window.location.href = `/vaqmas/appointments/${selectedAppointment.id}/edit`;
							}
						}}
					>
						Editar Cita
