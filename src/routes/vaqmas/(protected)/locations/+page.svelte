...
<div class="locations-page">
	...
	<div class="actions-bar">
		...
		<button
			class="create-btn"
			on:click={() => (window.location.href = '/vaqmas/locations/create')}
		>
							...
							<td>
								<div class="action-buttons">
									...
									<button
										...
										on:click={() =>
											(window.location.href = `/vaqmas/locations/${location.id}/edit`)}
										title="Editar"
									>
										<svg viewBox="0 0 24 24">
											<path
				...
				<div class="modal-footer">
					...
					<button
						...
						on:click={() => {
							if (selectedLocation) {
								closeDetails();
								window.location.href = `/vaqmas/locations/${selectedLocation.id}/edit`;
							}
						}}
					>
						Editar Ubicación
